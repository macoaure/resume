...
* Desenvolvimento backend: PHP, Laravel, Symfony, Go, Ruby on Rails e Node.js
* Arquitetura: microsserviços, modernização de plataformas, modernização de sistemas legados, APIs REST, GraphQL e integração de sistemas
* Cloud e DevOps: AWS, AWS Lambda, Kubernetes, Docker, GitHub Actions, Argo CD, GitLab CI/CD, Dokku e Buildpacks
* Dados e mensageria: MySQL, Redis, filas, mensageria assíncrona, integrações com ERPs e integrações bancárias
* Qualidade e entrega: CI/CD, observabilidade, resposta a incidentes, depuração, refatoração, testabilidade e documentação técnica
* Colaboração: liderança técnica, mentoria, apoio em recrutamento, planejamento, alinhamento com stakeholders e desenvolvimento assistido por inteligência artificial
